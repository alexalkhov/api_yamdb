    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.TextField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(regex='^[\\w.@+-]+\\Z')], verbose_name='логин')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.review', verbose_name='Автор комментария')),
            ],
        ),
    ]
